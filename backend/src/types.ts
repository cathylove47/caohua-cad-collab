...
export type ClientMessage =
  | {
      type: 'join';
      payload: { roomId: string; userId: string; username: string; color: string };
    }
  | {
      type: 'operation';
      payload: RoomOperation;
    }
  | {
      type: 'cursor';
      payload: { roomId: string; userId: string; username: string; color: string; x: number; y: number };
    };
